...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FullscreenPopGesture/FullscreenPopGesture.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KYWaterWaveView/KYWaterWaveView.framework"
