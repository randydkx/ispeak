...
//        控制progressHUD的动画显示模式
        ProgressHUD.animationType = .circleSpinFade
//        设置丝滑的屏幕间返回划动控制
        FullscreenPopGesture.configuration() 
        sleep(2)
//        let start_viewcontroller:lwsController = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(identifier: "lwscontroller") as! lwsController
//        self.window?.rootViewController = start_viewcontroller
